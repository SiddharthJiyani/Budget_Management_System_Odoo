...
const samplePaymentData = {
    paymentNo: 'PAY/25/0002',
    paymentDate: '2026-01-31',
    paymentType: 'bank', // cash or bank
    partner: 'Rauji Mobiles',
    amount: 17400,
    reference: 'Payment received from Invoice/Bill',
    status: 'draft', // draft, confirmed, cancelled
};

export default function InvoicePaymentForm({ onBack, onHome, onNew }) {
    ...
    return (
        <div className="animate-fadeIn">
            ...
            <div className="flex items-center justify-between mb-6">
                <div>
                    <h1 className="text-3xl font-bold text-foreground mb-1">Invoice Payment</h1>
                    <p className="text-sm text-muted-foreground">Record Incoming Payment</p>
                </div>
            </div>
